const CompoundingStreams = () => {
  return (
    <>
      <h1>Compounding Streams</h1>
      ...
      <h2>Codebase</h2>
      <p>
        The Sablier protocol codebase is hosted on <a>GitHub</a> and the source
        code for each contract is verified on Etherscan.
      </p>

      <h2>Minimal Architecture</h2>
      <p>
        We designed the protocol with simplicity in mind: one monolith smart
        contract that adheres to the <a>ERC-1620</a> standard. In our web
        interfaces, we rely on a few other proxies, but we will not cover those
        here.
      </p>
      ...
      <p>
        ...
        hold of the Sablier ABI (Application Binary Interface). The ABI acts as
        an interface between two program modules, one of which is the smart
      ...
      <h2>Networks</h2>
      <p>
        Depending on what Ethereum network you want to use Sablier with, you
        will need a specific contract address.
      </p>
    </>
  );
};

export default CompoundingStreams;
